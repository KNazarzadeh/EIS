classdef ESPM
    ...
    methods(Static)
        function ESPMinitialParameters( ...
            ...
            GeometricParameters.initialGeometricParameters( ...
                battery, ...
                applied_current, ...
                working_electrode, ...
                cycleNum);
            ...
            for electrode = working_electrode                
                battery.preComputedMatrix.electrode.(electrode) = ...
                FVMelectrode.compute_electrodeFVMMatirces( ...
                    battery.GeometricParams, ...
                    battery.TransportParams, ...
                    timeStep, ...
                    electrode);
            end
            
            % -------- Concentration parameters --------
            ConcentrationParameters.initialConcentrationParameters( ...
                battery, ...
                battery.preComputedMatrix.electrode, ...
                working_electrode, ...
                cycleNum);

            % -------- Kinetic parameters --------
            KineticParameters.initialKineticParameters( ...
                battery, ...
                applied_current, ...
                working_electrode, ...
                cycleNum);
            ...
            TransportParameters.initialTransportParameters( ...
                battery);
            ...
            battery.preComputedMatrix.electrolyte = FVMelectrolyte.compute_electrolyteFVMMatirces_FullCell( ...
                ...
                battery.ConcentrationParams.electrolyte.concentration_initial_elyte, ...
                temperature, ...
                timeStep);

            % -------- Thermodynamic parameters --------
            ThermodynamicParameters.initialThermodynamicParameters( ...
                battery, ...
                battery.preComputedMatrix.electrolyte, ...
                working_electrode, ...
                cycleNum);

            % -------- Electrical parameters --------
            ElectricalParameters.initialElectricalParameters( ...
                battery, ...
                applied_current, ...
                cycleNum);
        end
